...
class TestDepartamento:
    ...
    # +str(now.day)+ Modificação para pegar a data do dia atualizado, para testar aniversariantes
    def test_verificar_aniversariantes(self):
        retorno = [('João Oliveira', '1992-03-'+str(now.day)+'', 'Departamento XYZ'),
                   ('Luis Fernando', '2000-03-'+str(now.day)+'', 'Departamento XYZ'),
                   ('José da Silva', '1990-03-'+str(now.day)+'', 'Departamento XYZ')]
